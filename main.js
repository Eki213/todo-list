...
__webpack_require__.d(__webpack_exports__, {
  Cn: () => (/* binding */ addTodoToProject),
  bM: () => (/* binding */ checkTodo),
  X3: () => (/* binding */ deleteTodoByIndex),
  e3: () => (/* binding */ editProject),
  d0: () => (/* binding */ editTodo),
  U1: () => (/* binding */ getProject),
  l6: () => (/* binding */ getProjectTodos),
  MJ: () => (/* binding */ getTodoFromProject),
  Hf: () => (/* binding */ registerProject),
  oE: () => (/* binding */ removeProject)
});

;// ./src/createProject.js
/* harmony default export */ const createProject = (createProject_createProject);

function createProject_createProject(title, id = crypto.randomUUID()) {
    const todoItems = [];
...
/* harmony default export */ const createTodoItem = (createTodoItem_createTodoItem);

function createTodoItem_createTodoItem(title, description, date, priority, isCompleted = false) {
...
// Fallback for modularized imports:
/* harmony default export */ const en_GB = (enGB);
...
const getFormattedDate = date => date ? formatRelative_formatRelative(date, new Date(), { locale }) : "";
...
function displayController_load() {
